...
import { TeacherCourseSummary } from "@/types/profile";
import { BookOpen, ChevronRight } from "lucide-react";
import { Button } from "@/components/ui/button";

export default function TeacherCourseList({ courses }: { courses: TeacherCourseSummary[] }) {
    ...
    return (
        <div className="rounded-xl border border-[#DAD7CE] bg-white p-6">
            <div className="flex items-center justify-between mb-3">
                ...
                <Link href="/teacher/courses" className="text-sm font-medium text-[#1F6F5C] hover:text-[#175446]">View All</Link>
            </div>
            ...
            {courses.length === 0 ? (
                <div className="flex flex-col items-center justify-center gap-3 py-10 text-center">
                    ...
                    <p className="text-sm text-[#6B7369]">You haven&apos;t created any courses yet. Start by creating your first course.</p>
                    ...
                    {courses.map((course) => (
                        ...
                        >
                            <div className="relative z-10">
                                ...
                                <div className="text-xs text-[#6B7369]">
