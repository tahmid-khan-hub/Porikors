...
interface ProfileHeaderEditFieldsProps {
...
export default function ProfileHeaderEditFields({ identity, name, setName, institution, setInstitution,
phoneNumber, setPhoneNumber, isUploading, onFileSelected, isDeleting, onRemoveImage }: ProfileHeaderEditFieldsProps) {
