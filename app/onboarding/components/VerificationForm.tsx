...
export default function VerificationForm({ role, onBack } : VerificationFormProps) {
    ...
    return(
        <div className="rounded-xl border border-[#DAD7CE] bg-white p-6">
            <button
                onClick={onBack}
                className="text-xs text-[#1C2420]/50 hover:text-[#1C2420]"
            >
                back
            </button>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                ...
                <Button 
                    ...
                    className={"w-full rounded-lg bg-[#1F6F5C] text-white transition-colors hover:bg-[#175446] disabled:opacity-60"}>
